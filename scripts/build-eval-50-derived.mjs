...
const intentMap = {
  ...
  customer_ranking: "customer_revenue_ranking",
  customer_revenue_ranking: "customer_revenue_ranking",
  recent_orders_list: "recent_orders_list",
  source_revenue_drilldown: "source_revenue_drilldown",
  orders_filtered_list: "orders_filtered_list",
  ...
  inactive_sellers_recent: "inactive_sellers_recent",
...
const reviewFocusById = {
  ...
  "tc28-future-forecast": ["forecast_ytd_method", "grounding"],
  ...
  "tc44-cross-verify-leaderboard": ["cross_db_grounding", "consistency", "followup_verify", "source_disclosure"],
  "tc45-zero-result-seller": ["no_hallucination", "not_found_copy", "alias_resolution", "time_carryover"],
  "tc46-total-revenue-month": ["cross_db_grounding", "aggregation", "prompt_robustness", "source_disclosure"],
